        ...
        task.setId(LuckyBlock.instance.getServer().getScheduler().scheduleSyncRepeatingTask(LuckyBlock.instance, new Runnable() {
            ...
            public void run() {
                if (this.x > 0) {
                    ...
                    HTasks.playFixedSound(loc, HTasks.getSound("lb_drop_tntrain"), 1.0F, 0.0F, 50);
                    --this.x;
                } else {
                    task.run();
                }
        ...
        task.setId(LuckyBlock.instance.getServer().getScheduler().scheduleSyncRepeatingTask(LuckyBlock.instance, new Runnable() {
            ...
            public void run() {
                if (this.times > 0) {
                    ...
                    --this.times;
                    HTasks.playFixedSound(loc, HTasks.getSound("lb_drop_itemrain"), 1.0F, 0.0F, 20);
                } else {
                    task.run();
                }
        ...
        task.setId(LuckyBlock.instance.getServer().getScheduler().scheduleSyncRepeatingTask(LuckyBlock.instance, new Runnable() {
            ...
            public void run() {
                if (this.x > 0) {
                    ...
                    HTasks.playFixedSound(loc, HTasks.getSound("lb_drop_blockrain_launch"), 1.0F, 1.0F, 50);
                    HTasks.b1(fb);
                    --this.x;
                } else {
                    task.run();
        ...
        task.setId(LuckyBlock.instance.getServer().getScheduler().scheduleSyncRepeatingTask(LuckyBlock.instance, new Runnable() {
            public void run() {
                if (!fb.isValid()) {
                    ...
                    HTasks.playFixedSound(fb.getLocation(), HTasks.getSound("lb_drop_blockrain_land"), 1.0F, 1.0F, 60);
                    task.run();
                }
        ...
        task.setId(LuckyBlock.instance.getServer().getScheduler().scheduleSyncRepeatingTask(LuckyBlock.instance, new Runnable() {
            ...
            public void run() {
                if (this.x > 0) {
                    ...
                    a.setBounce(bounce);
                    HTasks.playFixedSound(loc, HTasks.getSound("lb_drop_arrowrain"), 1.0F, 1.0F, 50);
                    --this.x;
                } else {
                    task.run();
                }
            ...
            public void run() {
                if (items != null && this.x < items.length) {
                    if (items[this.x] != null) {
                        ...
                        HTasks.playFixedSound(loc, HTasks.getSound("lb_drop_itemrain"), 1.0F, 0.0F, 50);
                        ++this.x;
                    }
                } else {
                    task.run();
        ...
        task.setId(LuckyBlock.instance.getServer().getScheduler().scheduleSyncRepeatingTask(LuckyBlock.instance, new Runnable() {
            ...
            public void run() {
                if (this.x > 0) {
                    ...
                    double g1 = (double)h1 / 5.0D;
                    fb.setVelocity(new Vector(g, 1.0D, g1));
                    HTasks.playFixedSound(loc, HTasks.getSound("lb_drop_lbrain"), 1.0F, 1.0F, 50);
