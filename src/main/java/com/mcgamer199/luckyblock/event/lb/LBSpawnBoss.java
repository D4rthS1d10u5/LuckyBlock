        ...
        task.setId(ITask.getNewRepeating(LuckyBlock.instance, new Runnable() {
            ...
            public void run() {
                if (this.i > 0) {
                    ...
                    MyTasks.playFixedSound(loc, MyTasks.getSound("ritual_witch_particles"), 1.0F, 0.0F, 59);
                    --this.i;
                } else {
                    for(int x = -1; x < 2; ++x) {
                        for(int z = -1; z < 2; ++z) {
                    ...
                    MyTasks.playFixedSound(loc, MyTasks.getSound("ritual_witch_spawn"), 1.0F, 0.0F, 26);
                    task.run();
                }
