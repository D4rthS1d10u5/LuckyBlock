                ...
                public void run() {
                    if (!EntityHealer.this.healEntity.isDead() && !EntityHealer.this.ender.isDead()) {
                        if (EntityHealer.this.running && EntityHealer.this.healEntity.getHealth() < EntityHealer.this.healEntity.getMaxHealth()) {
                            ...
                            SoundManager.playFixedSound(EntityHealer.this.ender.getLocation(), SoundManager.getSound("boss_healer_heal"), 1.0F, 2.0F, 8);
            ...
            if (p.getInventory().getItemInMainHand() != null) {
                ...
                if (i.hasItemMeta() && i.getItemMeta().hasEnchant(Enchantment.DIG_SPEED) && i.getItemMeta().getEnchantLevel(Enchantment.DIG_SPEED) > 4) {
                    ...
                    if (this.health < 1) {
                        ...
                        SoundManager.playFixedSound(this.ender.getLocation(), SoundManager.getSound("boss_healer_death"), 1.0F, 1.0F, 8);
                        this.remove();
                        return;
                    }

                    SoundManager.playFixedSound(this.ender.getLocation(), SoundManager.getSound("boss_healer_damage"), 1.0F, 1.0F, 8);
