...
public class TellRawSender {
    ...
    public static com.mcgamer199.luckyblock.tellraw.RawText[] getFixedRawTexts(com.mcgamer199.luckyblock.tellraw.RawText[] texts) {
        com.mcgamer199.luckyblock.tellraw.RawText[] t = null;
        int i = 0;
        int g;
