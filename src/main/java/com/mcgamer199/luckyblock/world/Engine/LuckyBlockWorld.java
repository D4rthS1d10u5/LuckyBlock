...
import com.mcgamer199.luckyblock.world.Structures.Treasure;
import org.bukkit.*;
    ...
    private void onGenerate(ChunkLoadEvent event) {
        ...
        if (world.getGenerator() != null && world.getGenerator().getClass().getName().equalsIgnoreCase(this.getClass().getName())) {
            ...
            if (random.nextInt(100) > 97) {
                ...
                com.mcgamer199.luckyblock.world.Structures.LuckyTree tree = new com.mcgamer199.luckyblock.world.Structures.LuckyTree();
                tree.build(loc);
                return;
            }
            ...
            if (random.nextInt(100) > 97) {
                ...
                com.mcgamer199.luckyblock.world.Structures.LuckyDungeon dungeon = new com.mcgamer199.luckyblock.world.Structures.LuckyDungeon();
                dungeon.build(loc);
                return;
            }
            ...
            if (random.nextInt(100) > 97) {
                ...
                loc = new Location(world, (double)block.getX(), (double)block.getY(), (double)block.getZ());
                com.mcgamer199.luckyblock.world.Structures.PumpkinTower tower = new com.mcgamer199.luckyblock.world.Structures.PumpkinTower();
                tower.build(loc);
                return;
            }
            ...
            if (random.nextInt(100) > 97) {
                ...
                loc = new Location(world, (double)block.getX(), (double)block.getY(), (double)block.getZ());
                com.mcgamer199.luckyblock.world.Structures.LuckyTrap trap = new com.mcgamer199.luckyblock.world.Structures.LuckyTrap();
                trap.build(loc);
                return;
            }
            ...
            if (random.nextInt(100) > 97) {
                ...
                loc = new Location(world, (double)block.getX(), (double)block.getY(), (double)block.getZ());
                com.mcgamer199.luckyblock.world.Structures.WoolHouse whouse = new com.mcgamer199.luckyblock.world.Structures.WoolHouse();
                whouse.build(loc);
                return;
            }
            ...
            if (random.nextInt(100) > 98) {
                ...
                loc = new Location(world, (double)block.getX(), (double)(random.nextInt(4) + 6), (double)block.getZ());
                com.mcgamer199.luckyblock.world.Structures.Treasure treasure = new Treasure();
                treasure.build(loc);
                return;
            }
        }
