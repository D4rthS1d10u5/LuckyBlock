...
public class CustomEntityEvents implements Listener {
    ...
    public void onDamage(EntityDamageEvent event) {
        if (com.mcgamer199.luckyblock.entity.CustomEntity.getByUUID(event.getEntity().getUniqueId()) != null) {
            com.mcgamer199.luckyblock.entity.CustomEntity c = com.mcgamer199.luckyblock.entity.CustomEntity.getByUUID(event.getEntity().getUniqueId());
    ...
    public void onPlayerInteract(PlayerInteractEntityEvent event) {
        if (com.mcgamer199.luckyblock.entity.CustomEntity.getByUUID(event.getRightClicked().getUniqueId()) != null) {
            com.mcgamer199.luckyblock.entity.CustomEntity c = com.mcgamer199.luckyblock.entity.CustomEntity.getByUUID(event.getRightClicked().getUniqueId());
            if (c.entity != null) {
                c.onInteract(event);
            }
        }
    ...
    public void onPlayerDamage(EntityDamageByEntityEvent event) {
        if (com.mcgamer199.luckyblock.entity.CustomEntity.getByUUID(event.getDamager().getUniqueId()) != null && event.getEntity() instanceof Player) {
            com.mcgamer199.luckyblock.entity.CustomEntity c = com.mcgamer199.luckyblock.entity.CustomEntity.getByUUID(event.getDamager().getUniqueId());
            if (c.entity != null) {
    ...
    public void onDamageEntity(EntityDamageByEntityEvent event) {
        if (com.mcgamer199.luckyblock.entity.CustomEntity.getByUUID(event.getDamager().getUniqueId()) != null) {
            com.mcgamer199.luckyblock.entity.CustomEntity c = com.mcgamer199.luckyblock.entity.CustomEntity.getByUUID(event.getDamager().getUniqueId());
            if (c.entity != null) {
    ...
    public void onEntitySpawn(CreatureSpawnEvent event) {
        if (event.getSpawnReason() == CreatureSpawnEvent.SpawnReason.NATURAL && com.mcgamer199.luckyblock.entity.CustomEntity.getByReplacedEntity(event.getEntity().getType()) != null) {
            com.mcgamer199.luckyblock.entity.CustomEntity c = com.mcgamer199.luckyblock.entity.CustomEntity.getByReplacedEntity(event.getEntity().getType());
