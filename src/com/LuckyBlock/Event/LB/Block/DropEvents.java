            ...
            if (drop != null) {
                ...
                if (drop == LBDrop.CHEST) {
                    ...
                    if (block.getState() instanceof Chest) {
                        chestFiller = new ChestFiller(((FileConfiguration)file).getConfigurationSection(path), (Chest)block.getState());
                    ...
                    if (drop == LBDrop.EXPLOSIVE_CHEST) {
                        ...
                        if (path1 != null && s != null) {
                            ChestFiller c = new ChestFiller(((FileConfiguration)file).getConfigurationSection(path1), (Chest)block.getState());
                            c.loc1 = s;
                            c.fill();
                        }
                        ...
                        if (path1 == null) {
                            BlockTags.spawnRandomFallingBlock((FileConfiguration)file, path, bloc.add(0.5D, height, 0.5D));
                        } else {
                            BlockTags.spawnFallingBlock((FileConfiguration)file, path, path1, bloc.add(0.5D, height, 0.5D));
                        }
                        ...
                        if (path1 == null) {
                            EntityTags.spawnRandomEntity(((FileConfiguration)file).getConfigurationSection(path), bloc, player);
                        } else {
                            EntityTags.spawnEntity(((FileConfiguration)file).getConfigurationSection(path).getConfigurationSection(path1), bloc, ((FileConfiguration)file).getConfigurationSection(path), true, player);
                        }
                        ...
                        if (drop == LBDrop.SPLASH_POTION) {
                            ...
                            if (drop == LBDrop.DROPPED_ITEMS) {
                                ...
                                items = null;
                                if (path1 == null) {
                                    items = ItemStackTags.getRandomItems(((FileConfiguration)file).getConfigurationSection(path));
                                } else {
                                    items = ItemStackTags.getItems(((FileConfiguration)file).getConfigurationSection(path).getConfigurationSection(path1));
                                }
                                ...
                                if (drop == LBDrop.F_PIGS) {
                                    ...
                                    SuperSlime ss = new SuperSlime();
                                    randomP = (new Random()).nextInt(3) + 3;

                                    for(counter = randomP; counter > 0; --counter) {
                                        EntitySuperSlime su = new EntitySuperSlime();
                                        su.setSize(times);
                                        su.spawn(bloc);
                                        ss.add(su);
                                    }
                                    ...
                                    if (drop == LBDrop.METEORS) {
                                        ...
                                        if (lb.hasDropOption("Path1")) {
                                            ...
                                            path1 = BlockTags.getRandomL((FileConfiguration)file, path);
                                        }

                                        s = BlockTags.getValue((FileConfiguration)file, path, path1, "LocationType");
                                        if (s == null) {
                                            s = "BLOCK";
                                        }
                                        ...
                                        if (s.equalsIgnoreCase("PLAYER")) {
                                            if (player != null) {
                                                BlockTags.buildStructure(((FileConfiguration)file).getConfigurationSection(path).getConfigurationSection(path1), player.getLocation());
                                            } else {
                                                BlockTags.buildStructure(((FileConfiguration)file).getConfigurationSection(path).getConfigurationSection(path1), bloc);
                                            }
                                        } else {
                                            BlockTags.buildStructure(((FileConfiguration)file).getConfigurationSection(path).getConfigurationSection(path1), bloc);
                                        }
                                        ...
                                        EntityRandomItem r = new EntityRandomItem();
                                        ...
                                        while(var49.hasNext()) {
                                            ...
                                            r.items.add(ItemStackGetter.getItemStack((FileConfiguration)file, path + "." + s + ".Items." + g));
                                        }
                                        ...
                                        if (drop == LBDrop.ITEM_RAIN) {
                                            ...
                                            EntityTalkingZombie e = new EntityTalkingZombie();
                                            e.spawn(bloc);
                                        } else {
