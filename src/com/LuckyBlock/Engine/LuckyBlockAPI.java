...
public class LuckyBlockAPI implements Listener {
    ...
    static {
        lbsF = new File(LuckyBlock.instance.getDataFolder() + File.separator + "LuckyBlocks.yml");
        lbs = YamlConfiguration.loadConfiguration(lbsF);
        lbwblocks = new ArrayList();
        detectors = new ArrayList();
        locations = new ArrayList();
        portalsF = new File(LuckyBlock.instance.getDataFolder() + File.separator + "Data/Portals.yml");
    ...
    public static void loadLuckyBlocks() {
        if (!loaded) {
            loaded = true;
            LuckyBlock.instance.getLogger().info(MyTasks.val("log.lb.loading", false));
            int total = 0;
            ...
            try {
                ...
                if (total == 1) {
                    ...
                    LuckyBlock.instance.getLogger().info(s);
                }
    ...
    public static String getDet(int id) {
        String s = null;
        ConfigurationSection cs = LuckyBlock.instance.detectors.getConfigurationSection("Detectors");
