...
import com.LuckyBlock.customentity.boss.main.BossFunctions.ParticleHelper;
...
public class EntityUnderwaterBoss extends CustomEntity implements EntityLBBoss {
            ...
            public void run() {
                if (!EntityUnderwaterBoss.this.elder.isDead()) {
                    if (EntityUnderwaterBoss.this.checkFollowers() < 6) {
                        EntityUnderwaterFollower follower = new EntityUnderwaterFollower();
                        follower.age = 280;
    ...
    private Vector getRandomVelocity() {
        double x1 = (double)(this.random.nextInt(80) - 40);
        double z1 = (double)(this.random.nextInt(80) - 40);
        double x2 = x1 / 50.0D;
        double z2 = z1 / 50.0D;
