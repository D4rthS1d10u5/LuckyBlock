...
public class BossFunctions {
    ...
    public static void shoot_beam(EntityLBBoss boss, LivingEntity entity, LivingEntity target, int max, BossFunctions.ParticleHelper helper) {
        shoot_beam(entity.getLocation(), boss, target, max, 0.4D, helper, (String)null);
    }

    public static void shoot_beam(EntityLBBoss boss, LivingEntity entity, LivingEntity target, int max, double s, BossFunctions.ParticleHelper helper) {
